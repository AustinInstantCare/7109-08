...
_Bool ADXL345_ClearInterrupt(void);
_Bool SetupForFreefall(void);
_Bool setupForImpact(void);
_Bool setupForInactivity(void);
# 37 "./fall.h" 2
...
void MotionEventHandler(State_t *state) {
    ...
    switch (*state) {
        ...
        case WAITING_FOR_TIMEOUT:
            ...
            else if (orientation_check_timer_20ms >= 5) {
                orientation_check_timer_20ms = 0;
                if (Orientation_Up()) {

                    if (good_orientation_count++ >= 10) {
