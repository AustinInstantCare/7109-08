...
int main(void)
{
    ...
    if (EEPROM_Read(0x10) != 0x57) {
        ...
        uint8_t X_val = ( EEADR = 0x02, EECON1 &= 0x3F, EECON1bits.RD = 1, EEDATA);
        uint8_t Y_val = ( EEADR = 0x04, EECON1 &= 0x3F, EECON1bits.RD = 1, EEDATA);
        uint8_t Z_val = ( EEADR = 0x06, EECON1 &= 0x3F, EECON1bits.RD = 1, EEDATA);
